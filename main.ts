...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Enemy, function (sprite5, otherSprite) {
    if (otherSprite == mySprite) {
        ...
        if (GF_HEALTH.value == 0) {
            ...
            game.setGameOverMessage(true, "YOU WON!!! TIME:" + ("" + game.runtime() / 1000) + "SECONDS")
            game.gameOver(true)
        }
    }
})
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile19`, function (sprite4, location4) {
    game.splash("Congratulations, ", plrname)
    game.splash("You have collected a gem!")
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile17`, function (sprite3, location3) {
    game.splash("Congratulations, ", plrname)
    game.splash("You have collected a gem!")
